<template>
    <v-container fluid style="position: relative;height: 100%;">
        <Split style="min-height: calc(100% - 100px)" :gutterSize="4">
                            ...
                            <Draggable v-for="(data, i) in themeData" :key="i" style="background-color: white;"
                                    ...
                                    <div class="d-flex justify-space-between">
                                        <div
                                            ...
                                            <!-- {{data.html}} -->
                                            <dynamic v-bind:template="data.html"></dynamic>
            ...
            <SplitArea :size="1" :minSize="100"></SplitArea>
        </Split>
...
<script>
    ...
    import topextsec from "../../../../client/shared/topextsec";
    import mainPageTopBar from "../../../../client/shared/mainPageTopBar";
