...
/* harmony import */ var _client_shared_topextsec__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../client/shared/topextsec */ "./resources/js/components/client/shared/topextsec.vue");
/* harmony import */ var _client_shared_mainPageTopBar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../client/shared/mainPageTopBar */ "./resources/js/components/client/shared/mainPageTopBar.vue");
...
var dynamic = {
  ...
  created: function created() {
    ...
    axios.get("http://localhost:8000/import_menu").then(function (response) {
      _this.menudata = response.data;
      _this.select_menu = _this.get_submenu(0);
    }).catch(function (e) {
      _this.errors.push(e);
    });
    axios.get("http://localhost:8000/import_client_main").then(function (response) {
  ...
  components: {
    topextsec: _client_shared_topextsec__WEBPACK_IMPORTED_MODULE_5__["default"],
    mainPageTopBar: _client_shared_mainPageTopBar__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  ...
  watch: {
    ...
    template: {
      ...
      handler: function handler() {
        ...
        this.templateRender = res.render; // staticRenderFns belong into $options, 
        // appearantly

        this.$options.staticRenderFns = []; // clean the cache of static elements
        // this is a cache with the results from the staticRenderFns

        this._staticTrees = []; // Fill it with the new staticRenderFns
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    console.log('created');
    this.themeData = [{
      'html': "<topextsec></topextsec>",
      height: 200
    }, {
      'html': "<mainPageTopBar></mainPageTopBar>",
      height: 200
    }, {
      'html': "<v-btn>asdf</v-btn>",
      height: 200
    }];
  },
  methods: {
        ...
        [
          ...
          _c(
            "SplitArea",
            {
              ...
              attrs: { id: "mainPane", size: 84, minSize: 200 }
            },
            [
              _c(
                "v-resizable",
          ...
          _vm._v(" "),
          _c("SplitArea", { attrs: { size: 1, minSize: 100 } })
        ],
        1
      ),
      _vm._v(" "),
